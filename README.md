...
- **🎛️ Unified Management** — Add, configure, and manage multiple bots from a single dashboard.
...
| :--- | :--- |
| **⚙️ Backend** | FastAPI, SQLAlchemy, SQLite, Pydantic, Uvicorn |
...
bot-dashboard/
│
├── ⚙️ backend/           # FastAPI application, routes, and database models
